...
include::{snippets}/get-chat-room-info/http-request.adoc[]
include::{snippets}/get-chat-room-info/query-parameters.adoc[]

=== Response (Success)

include::{snippets}/get-chat-room-info/http-response.adoc[]
include::{snippets}/get-chat-room-info/response-fields.adoc[]
